...
export interface InternalEventOptions<T extends AbstractControl = AbstractControl> {
  emitEvent?: boolean;
  onlySelf?: boolean;
  sourceControl?: T;
}
...
export interface ControlEvent<T extends AbstractControl = AbstractControl> {
  source: T;
}
 ...
 */
export class ValueChangeEvent<V, C extends AbstractControl = AbstractControl> implements ControlEvent<C> {
  constructor(
 ...
 */
export class StatusChangeEvent<C extends AbstractControl = AbstractControl> implements ControlEvent<C> {
  constructor(
    public readonly status: ControlStatus,
    public readonly source: C,
  ) {}
}
 ...
 */
export class PristineChangeEvent<C extends AbstractControl = AbstractControl> implements ControlEvent<C> {
  constructor(
 ...
 */
export class TouchedChangeEvent<C extends AbstractControl = AbstractControl> implements ControlEvent<C> {
  constructor(
 ...
 */
export class DisabledChangeEvent<C extends AbstractControl = AbstractControl> implements ControlEvent<C> {
  constructor(
 ...
 */
export abstract class AbstractControl<ControlValue = any> {
  /**
   * @internal
   * @member
  ...
  /** @internal */
  public markAsTouched<T extends AbstractControl>(options: InternalEventOptions<T>): void;
  public markAsTouched<T extends AbstractControl>(options: InternalEventOptions<T> = {}): void {
  ...
  /** @internal */
  public markAsUntouched<T extends AbstractControl>(options: InternalEventOptions<T>): void;
  public markAsUntouched<T extends AbstractControl>(options: InternalEventOptions<T> = {}): void {
  ...
  /** @internal */
  public markAsDirty<T extends AbstractControl>(options: InternalEventOptions<T>): void;
  public markAsDirty<T extends AbstractControl>(options: InternalEventOptions<T> = {}): void {
  ...
  /** @internal */
  public markAsPristine<T extends AbstractControl>(options: InternalEventOptions<T>): void;
  public markAsPristine<T extends AbstractControl>(options: InternalEventOptions<T> = {}): void {
    this._updateDirty(false, options);
  }

  /** @internal */
  public _updateTouched<T extends AbstractControl>(
    touched: boolean,
  ...
  /** @internal */
  protected _updateDirty<T extends AbstractControl>(
    dirty: boolean,
    { emitEvent = true, onlySelf = false, sourceControl }: InternalEventOptions<T>,
  ): void {
  ...
  /** @internal */
  public _updateValueAndStatus<T extends AbstractControl>({
    emitEvent = true,
    onlySelf = false,
    sourceControl,
